    ...
    <div className="flex min-h-svh flex-col bg-primary">
      ...
      <div className="space-y-3 px-8 pb-16 animate-in fade-in-0 slide-in-from-bottom-4 duration-500 delay-[350ms] fill-mode-both">
        ...
        <button
          ...
          disabled={pending}
          className="flex h-14 w-full max-w-sm mx-auto items-center justify-center gap-2.5 rounded-full bg-white font-semibold text-[#3C4043] transition-all hover:opacity-90 active:scale-[0.98] cursor-pointer disabled:opacity-70 disabled:cursor-default"
        >
          {pending ? (
            <Loader2 className="h-[18px] w-[18px] animate-spin" />
          ) : (
